...
export default function Disclaimer() {
  return (
    <PolicyPageLayout icon={AlertTriangle} title="Disclaimer">
      <p>
        The information provided by MessMaster Proon our web application is for general informational and mess
      ...
      <p>
        ...
        MessMaster Procannot guarantee complete absence of trace allergens.
      </p>
      ...
      <p>
        We strive to ensure continuous system and meal service availability. However, MessMaster Prois not liable for
